...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet" href="information.css">
</head>
<body>
   ...
   <div class="breadcrumbwrap">
        ...
        <ul class="breadcrumb">
            ...
            <li>Χρήσιμα</li>
            <li><a href="information.php">Πληροφορίες</a></li>
        </ul>
    </div>
    <div class="bodywrap">
        <div class=informationwrap>
            <div class=title>ΗΛΕΚΤΡΟΝΙΚΗ ΥΠΗΡΕΣΙΑ ΟΛΟΚΛΗΡΩΜΕΝΗΣ ΔΙΑΧΕΙΡΙΣΗΣ ΣΥΓΓΡΑΜΜΑΤΩΝ</div>
            <p>
                ...
                Το έργο εκτελείται για πρώτη φορά το ακαδημαϊκό έτος 2010-11 για όλους τους προπτυχιακούς φοιτητές όλων των Πανεπιστημίων/ΤΕΙ της χώρας. Από το ακαδημαϊκό έτος 2016-2017, στη διανομή των ακαδημαϊκών συγγραμμάτων συμμετέχουν και τα προπτυχιακά τμήματα του Ελληνικού Ανοικτού Πανεπιστημίου.</br></br>
                <u>Η διαδικασία είναι πλήρως αυτοματοποιημένη και προσφέρει:</u></br>
                ...
                (γ) Αποτελεσματικούς μηχανισμούς για την ταχεία αποζημίωση των Εκδοτών και για την αποτροπή της καταχρηστικής εκμετάλλευσης των δημόσιων πόρων</br></br>
                <u>Περιγραφή φάσεων/διαδικασιών</u></br>
                ...
                6. Το Υπουργείο Παιδείας ενημερώνεται σε πραγματικό χρόνο για την πορεία του έργου και μεριμνά για την ταχεία αποζημίωση των εκδοτών.</br></br>
                <u>Αναμενόμενα Πλεονεκτήματα</u></br>
                ...
                Γ. Απλοποιείται η σχέση του Υπουργείου Παιδείας με τους Εκδότες, ελαχιστοποιώντας την ανάγκη ανταλλαγής εγγράφων - λιστών.
                ...
                Η. Δημιουργούνται οι προϋποθέσεις για την ασφαλή και σταδιακή μετάβαση στην εποχή του ηλεκτρονικού Συγγράμματος</br></br>
            </p>
        </div>
    </div>
</body>
